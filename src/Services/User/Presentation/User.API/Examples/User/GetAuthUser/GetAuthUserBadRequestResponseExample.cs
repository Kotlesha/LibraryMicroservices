...
namespace User.API.Examples.User.GetAuthUser;

public class GetAuthUserBadRequestResponseExample : IExamplesProvider<ProblemDetails>
{
    public ProblemDetails GetExamples()
    {
        ...
        return new()
        {
            ...
            Extensions = new Dictionary<string, object?>()
            {
                ...
                ["errors"] = ApplicationErrors.User.InvalidUserIdFromat
            }
        };
    }
}
